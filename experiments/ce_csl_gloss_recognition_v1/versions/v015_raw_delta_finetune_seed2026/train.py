...
CHECKPOINT_DIR = PROCESSED_DIR / "checkpoints" / "full_bilstm_ctc_raw_delta_finetune_seed2026"
LOG_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_finetune_seed2026"
    ...
    history_rows: List[Dict] = [
        {
            ...
            "bestDevLoss": None,
            "bestDevTEREpoch": best_dev_ter_epoch,
            "epochSeconds": 0.0,
            "elapsedMinutes": 0.0,
