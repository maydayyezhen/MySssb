...
- 已经生成：
  D:\\CE-CSL\\CE-CSL\\processed\\logs\\full_bilstm_ctc\\prediction_diagnosis\\best_dev_ter_all_examples.jsonl
"""
...
PREDICTION_DIAGNOSIS_DIR = (
    PROCESSED_DIR / "logs" / "full_bilstm_ctc" / "prediction_diagnosis"
)
...
# 输出目录
OUTPUT_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc" / "token_frequency_diagnosis"
