"""
v016 top_k_1000 controlled vocab 预测诊断

作用：
1. 加载 controlled top_k_1000 的 best_dev_ter.pt。
...
def main() -> None:
    ...
    主入口。
    """
    print("===== v016 top_k_1000 controlled prediction inspect 开始 =====")
    ...
    print("\n已写出:", OUTPUT_DIR)
    print("===== v016 top_k_1000 controlled prediction inspect 结束 =====")
