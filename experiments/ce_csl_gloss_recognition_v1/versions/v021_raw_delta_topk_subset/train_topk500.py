...
from subset_dataset import TopKSubsetCeCslGlossDataset  # noqa: E402
...
SUBSET_NAME = "top_k_500"
SUBSET_DIR = PROCESSED_DIR / "subsets" / "v021_raw_delta_topk_subset" / SUBSET_NAME
SUBSET_VOCAB_PATH = SUBSET_DIR / "vocab.json"

CHECKPOINT_DIR = PROCESSED_DIR / "checkpoints" / "raw_delta_topk500_subset"
LOG_DIR = PROCESSED_DIR / "logs" / "raw_delta_topk500_subset"
...
def infer_vocab_size_from_subset_vocab() -> int:
    """
    从 subset vocab.json 读取 vocab_size。
    ...
    Returns:
        subset vocab size。
    """
    vocab = TopKSubsetCeCslGlossDataset.read_vocab(SUBSET_VOCAB_PATH)

    return int(vocab["vocabSize"])
...
def main() -> None:
    ...
    device = get_device()
    vocab_size = infer_vocab_size_from_subset_vocab()

    print("device:", device)
    print("subset_name:", SUBSET_NAME)
    print("subset_dir:", SUBSET_DIR)
    print("subset_vocab_path:", SUBSET_VOCAB_PATH)
    ...
    train_dataset = TopKSubsetCeCslGlossDataset(
    ...
    dev_dataset = TopKSubsetCeCslGlossDataset(
        dataset_root=DATASET_ROOT,
        split="dev",
        subset_dir=SUBSET_DIR,
    ...
    train_config = {
        ...
        "subset_vocab_path": str(SUBSET_VOCAB_PATH),
        "subset_vocab_size": vocab_size,
        "task_type": "controlled_topk_subset",
        "seed": SEED,
