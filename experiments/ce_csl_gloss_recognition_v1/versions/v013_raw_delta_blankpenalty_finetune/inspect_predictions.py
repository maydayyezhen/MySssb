...
LOG_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_blankpenalty_finetune" / "prediction_diagnosis"
...
def apply_blank_logit_penalty(
    ...
    """
    Match v013 training/evaluation decoding by lowering blank probability.
    """
