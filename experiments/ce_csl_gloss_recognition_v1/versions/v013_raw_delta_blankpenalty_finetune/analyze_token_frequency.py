...
- 已经生成：
  D:\\CE-CSL\\CE-CSL\\processed\\logs\\full_bilstm_ctc_raw_delta\\prediction_diagnosis\\best_dev_ter_all_examples.jsonl
"""
...
PREDICTION_DIAGNOSIS_DIR = (
    PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_blankpenalty_finetune" / "prediction_diagnosis"
)

OUTPUT_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_blankpenalty_finetune" / "token_frequency_diagnosis"
