...
CHECKPOINT_DIR = PROCESSED_DIR / "checkpoints" / "full_bilstm_ctc_raw_delta_presence_mask"
LOG_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_presence_mask" / "prediction_diagnosis"
