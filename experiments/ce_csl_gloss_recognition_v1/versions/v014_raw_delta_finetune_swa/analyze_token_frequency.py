...
PREDICTION_DIAGNOSIS_DIR = (
    PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_finetune_swa" / "prediction_diagnosis"
)

OUTPUT_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_finetune_swa" / "token_frequency_diagnosis"
