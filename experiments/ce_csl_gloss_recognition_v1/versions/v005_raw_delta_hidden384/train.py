"""
CE-CSL BiLSTM-CTC 全量训练脚本 v5：raw_delta + hidden_size=384
...
- 本实验保留 v2 raw_delta 的训练策略，只把 BiLSTM hidden_size 从 256 增加到 384。
"""
...
CHECKPOINT_DIR = PROCESSED_DIR / "checkpoints" / "full_bilstm_ctc_raw_delta_hidden384"
LOG_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_hidden384"
