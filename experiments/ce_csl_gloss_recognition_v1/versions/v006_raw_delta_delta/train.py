"""
CE-CSL BiLSTM-CTC 全量训练脚本 v6：raw_delta_delta
...
- 本实验保留 v2 raw_delta 的训练策略，只把输入特征扩展为 raw + delta + delta_delta。
"""
...
CHECKPOINT_DIR = PROCESSED_DIR / "checkpoints" / "full_bilstm_ctc_raw_delta_delta"
LOG_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_delta"
