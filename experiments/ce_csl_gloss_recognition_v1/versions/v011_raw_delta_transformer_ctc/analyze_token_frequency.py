...
- 已经生成：
  D:\\CE-CSL\\CE-CSL\\processed\\logs\\full_transformer_ctc_raw_delta\\prediction_diagnosis\\best_dev_ter_all_examples.jsonl
"""
...
PREDICTION_DIAGNOSIS_DIR = (
    PROCESSED_DIR / "logs" / "full_transformer_ctc_raw_delta" / "prediction_diagnosis"
)

OUTPUT_DIR = PROCESSED_DIR / "logs" / "full_transformer_ctc_raw_delta" / "token_frequency_diagnosis"
