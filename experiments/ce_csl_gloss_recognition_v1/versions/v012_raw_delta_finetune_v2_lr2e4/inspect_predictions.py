...
CHECKPOINT_DIR = PROCESSED_DIR / "checkpoints" / "full_bilstm_ctc_raw_delta_finetune_v2_lr2e4"
LOG_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_finetune_v2_lr2e4" / "prediction_diagnosis"
