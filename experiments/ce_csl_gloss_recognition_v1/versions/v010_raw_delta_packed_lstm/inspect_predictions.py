...
from ce_csl.model import PackedBiLstmCtcModel  # noqa: E402
...
CHECKPOINT_DIR = PROCESSED_DIR / "checkpoints" / "full_bilstm_ctc_raw_delta_packed_lstm"
LOG_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_packed_lstm" / "prediction_diagnosis"
...
def load_model_from_checkpoint(
    ...
    device: torch.device,
) -> Tuple[PackedBiLstmCtcModel, Dict]:
    """
    加载 checkpoint 并构建模型。
    """
    ...
    model = PackedBiLstmCtcModel(**model_config).to(device)
