...
from ce_csl.model import TemporalConvBiLstmCtcModel  # noqa: E402
...
CHECKPOINT_DIR = PROCESSED_DIR / "checkpoints" / "full_bilstm_ctc_raw_delta_tcn_frontend"
LOG_DIR = PROCESSED_DIR / "logs" / "full_bilstm_ctc_raw_delta_tcn_frontend" / "prediction_diagnosis"
...
def load_model_from_checkpoint(
    ...
    device: torch.device,
) -> Tuple[TemporalConvBiLstmCtcModel, Dict]:
    """
    加载 checkpoint 并构建模型。
    """
    ...
    model = TemporalConvBiLstmCtcModel(**model_config).to(device)
